...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'shop', 'templates/'), os.path.join(BASE_DIR, 'search_app', 'templates/'),os.path.join(BASE_DIR, 'wish', 'templates/'),os.path.join(BASE_DIR, 'cart', 'templates/'), os.path.join(BASE_DIR, 'order', 'templates/')],
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'wish.context_processors.counter', 
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = "iamanujnmehere@gmail.com"
